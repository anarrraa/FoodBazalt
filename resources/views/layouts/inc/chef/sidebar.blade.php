<div id="sidebar">
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-footer position-absolute bottom-0 p-1 w-100">
            <div class="d-flex justify-content-between align-items-center p-2 w-100">
                <div class="d-flex align-items-center">
                    ...
                    <form method="POST" action="{{ route('chef.logout') }}" class="ml-2">
                        @csrf
                        <button
                            type="submit"
                            class="btn btn-danger d-flex align-items-center"
                            style="border-radius: 10px; font-weight: bold; padding: 5px 10px; margin-left:20px;">
                            Гарах
                        </button>
                    </form>
