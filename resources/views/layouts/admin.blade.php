...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&family=Pacifico&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
...
<body>
    ...
    <script src="{{asset('chef/assets/static/js/components/dark.js')}}"></script>
    <script src="{{asset('chef/assets/static/js/components/sidebar.js')}}"></script>
    <script src="{{asset('chef/assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
    <script src="{{asset('chef/assets/compiled/js/app.js')}}"></script>
