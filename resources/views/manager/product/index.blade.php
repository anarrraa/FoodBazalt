                ...
                <div class="card-header p-3 align-items-center d-flex justify-content-between">
                    ...
                    <div class="float-end">
                        <div class="create-page">
                            ...
                            <a href="{{ route('manager.product.create') }}" class="btn btn-primary">
                                +&nbsp; Бүтээгдэхүүн нэмэх
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div class="dropdown dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-black fade">
                                                <li class="d-flex align-items-center text-left me-3">
                                                    <a href="{{ route('manager.product.edit', $item->id) }}" class="dropdown-item text-primary p-2" data-toggle="tooltip">
                                                        <i class="fas fa-edit mr-2"></i>Өөрчлөх
                                                    </a>
                                                </li>
                                                <li class="d-flex align-items-center text-left me-3">
                                                    <a href="{{ route('manager.product.image', ['id' => $item->id]) }}" class="dropdown-item text-success p-2" data-toggle="tooltip">
                                                        <i class="fas fa-image mr-2"></i>
                                                        Зураг нэмэх
                                                    </a>
                                                </li>
                                                <li class="d-flex align-items-center text-left me-3">
                                                    <form id="delete-form" action="{{ route('manager.product.destroy', $item->id) }}" method="POST" style="display:inline; width:100%">
                                                        @csrf
                                                        @method('DELETE')
