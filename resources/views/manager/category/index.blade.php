                                ...
                                <div
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title d-flex justify-content-center fs-3"
                                                id="myModalLabel33">Ангилал Нэмэх Форум</h4>
                                            <button
                                                type="button"
                                                class="close"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset($item->thumbnail) }}"
                                             class="avatar avatar-sm me-3 border-radius-lg" alt="user1" width="150px"
                                             height="150px">
                                    </td>
                                    <td>
                                        @if($item->restaurant)
                                    ...
                                    <td class="editDelete justify-content-right">
                                            ...
                                            <ul class="dropdown-menu shadow-lg">
                                                ...
                                                <li>
                                                    <form id="delete-form-{{ $item->id }}"
                                                          action="{{ route('manager.category.destroy', $item->id) }}"
                                        ...
                                        <!-- Edit Modal -->
                                        <div class="modal fade text-left" id="editModal{{ $item->id }}" tabindex="-1"
                                                        ...
                                                        <div class="card">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="card-head">
                                                                            <h4 class="font-weight-light">Ангилал
                                                                                засах:</h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="card-body">
                                                                            <form
                                                                                action="{{ route('manager.category.update', $item->id) }}"
                                                                                method="POST"
                                                                                enctype="multipart/form-data">
                                                                                @csrf
                                                                                @method('PUT')
